<x-layouts.auth title="Sign in">
    <main class="auth-page">
        <section class="auth-surface" aria-labelledby="sign-in-title">
            ...
            <form method="POST" action="{{ url('/login') }}" class="auth-card" data-login-form >
                @csrf
                ...
                <div class="field">
                    ...
                    <div class="field-control">
                        <input class="field-input" id="email" type="email"  placeholder="Email" autocomplete="email" name="email">
                        @error('email')
                ...
                <div class="field">
                    ...
                    <div class="field-control">
                        <input class="field-input" id="password" type="password" placeholder="Password" name="password" autocomplete="current-password" aria-describedby="password-hint">
