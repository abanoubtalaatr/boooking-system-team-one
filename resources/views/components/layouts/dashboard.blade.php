...
@php
    ...
    $navigation = $isDoctor
        ? [
            ...
            ['جدول المواعيد', 'clock', route('doctor.schedule'), request()->routeIs('doctor.schedule'), null],
        ...
        : [
            ...
            ['العيادات', 'clinic', route('admin.clinics'), request()->routeIs('admin.clinics'), 'clinics.view'],
            ['المواعيد', 'clock', route('admin.appointments'), request()->routeIs('admin.appointments'), 'appointments.view'],
